# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2022-08-23 09:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_space', models.IntegerField(default=0, verbose_name='已使用空间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.SmallIntegerField(choices=[(1, '未支付'), (2, '已支付')], verbose_name='交易状态')),
